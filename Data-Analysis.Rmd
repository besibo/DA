...
```{r density, warning=FALSE, tidy=FALSE, message=FALSE, fig.cap="Un exemple de courbe de densité."}
ggplot(weather, aes(x = temp)) +
  geom_density()
```
...
```{r densitynarrow, warning=FALSE, tidy=FALSE, message=FALSE, fig.cap="Un exemple de courbe de densité trop peu lissée."}
ggplot(weather, aes(x = temp)) +
  geom_density(bw = 0.5)
```
...
```{r densitywide, warning=FALSE, tidy=FALSE, message=FALSE, fig.cap="Un exemple de courbe de densité trop lissée."}
ggplot(weather, aes(x = temp)) +
  geom_density(bw = 10)
```
