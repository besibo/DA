...
list.of.packages <- c("nycflights13", "gapminder", "knitr", "tidyverse", "gridExtra", "devtools", "extrafont", "kableExtra", "bindrcpp", "skimr", "sysfonts") # bindrcpp is needed for Travis-CI to compile the book
...
font_add("FuturaLT",
         regular = "FuturaLT.ttf", 
         bold = "FuturaLT-Bold.ttf",
         italic = "FuturaLT-Oblique.ttf",
         bolditalic = "FuturaLT-BoldOblique.ttf"
         )
