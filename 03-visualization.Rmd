...
ggplot(alaska_flights, 
       aes(x = dep_delay, y = arr_delay, color = factor(month))) +
  geom_point() +
  labs(title = "Relation linéaire positive entre le retard des vols
                au départ et à l'arrivée",
       subtitle = "L'essentiel des points est centré sur 0, 
                   mais certains retards dépassent 3 heures",
