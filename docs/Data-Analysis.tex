...
{\centering \includegraphics[width=0.9\linewidth]{figure/unnamed-chunk-89-1} 

}

\caption{Notre premier graphique, produit grâce au pipe}\label{fig:unnamed-chunk-89}
\end{figure}
...
{\centering \includegraphics[width=0.5\linewidth]{figure/unnamed-chunk-132-1} 

}

\caption{Indice Gonado Somatique  selon le sexe.}\label{fig:unnamed-chunk-132}
\end{figure}
...
{\centering \includegraphics[width=0.5\linewidth]{figure/unnamed-chunk-135-1} 

}

\caption{Indice Gonado Somatique  selon le sexe.}\label{fig:unnamed-chunk-135}
\end{figure}
