...
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{Sexe =} \KeywordTok{fct_recode}\NormalTok{(Sexe, }
                           \StringTok{"Female"}\NormalTok{ =}\StringTok{ "f"}\NormalTok{,}
                           \StringTok{"Male"}\NormalTok{ =}\StringTok{ "m"}\NormalTok{),}
         \DataTypeTok{Statut =} \KeywordTok{fct_relevel}\NormalTok{(Statut, }\StringTok{"imm"}\NormalTok{, }\StringTok{"mat"}\NormalTok{, }\StringTok{"pnl"}\NormalTok{, }\StringTok{"l"}\NormalTok{, }\StringTok{"pl"}\NormalTok{, }\StringTok{"repos"}\NormalTok{))}
\NormalTok{dauphin}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{library}\NormalTok{(readxl)}
\NormalTok{dauphin <-}\StringTok{ }\KeywordTok{read_excel}\NormalTok{(}\StringTok{"data/dauphin.xls"}\NormalTok{, }\DataTypeTok{na =} \StringTok{"*"}\NormalTok{, }\DataTypeTok{skip =} \DecValTok{9}\NormalTok{) }\OperatorTok{%>%}\StringTok{   }\CommentTok{# Importation, puis}
\StringTok{  }\KeywordTok{rename}\NormalTok{(}\DataTypeTok{ID =} \StringTok{`}\DataTypeTok{N°}\StringTok{`}\NormalTok{,                          }\CommentTok{# On donne des noms courts, puis}
...
\StringTok{  }\KeywordTok{select}\NormalTok{(}\OperatorTok{-}\NormalTok{ID) }\OperatorTok{%>%}\StringTok{                           }\CommentTok{# On supprime la colonne `ID`, puis}
\StringTok{  }\KeywordTok{mutate_if}\NormalTok{(is.character, as.factor) }\OperatorTok{%>%}\StringTok{    }\CommentTok{# On transforme en facteurs les variables <chr>, puis}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{Sexe =} \KeywordTok{fct_recode}\NormalTok{(Sexe,            }\CommentTok{# On modifie les niveau de `Sexe` et l'ordre des niveaux de Statut}
                           \StringTok{"Female"}\NormalTok{ =}\StringTok{ "f"}\NormalTok{,}
                           \StringTok{"Male"}\NormalTok{ =}\StringTok{ "m"}\NormalTok{),}
         \DataTypeTok{Statut =} \KeywordTok{fct_relevel}\NormalTok{(Statut, }\StringTok{"imm"}\NormalTok{, }\StringTok{"mat"}\NormalTok{, }\StringTok{"pnl"}\NormalTok{, }\StringTok{"l"}\NormalTok{, }\StringTok{"pl"}\NormalTok{, }\StringTok{"repos"}\NormalTok{))}
...
Une rapide recherche dans un moteur de recherche vous apprendra que ces
aéroports ne sont pas situés sur le sol américain. Trois d'entre eux
sont situés à Puerto Rico (\texttt{SJU}, \texttt{BQN} et \texttt{PSE})
et le dernier (\texttt{STT}) est situé aux Îles Vierges.
