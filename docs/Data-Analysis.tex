...
\item
  Produire des scripts clairs sous R ou RStudio, permettant la reproductibilité de ses analyses et la communication avec ses pairs
\item
...
\item
  Maîtriser les logiciels R ou RStudio pour realiser des analyses statistiques, des représentations graphiques ou des simulations numériques
\end{enumerate}
