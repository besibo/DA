...
\caption{Ajout des données brutes sous forme de 'tapis' (`rug`) sous l'histogramme.}\label{fig:unnamed-chunk-47}
\end{figure}
...
\caption{Modification de la largeur des classes avec `binwidth`.}\label{fig:unnamed-chunk-48}
\end{figure}
...
\caption{Spécification manuelle des limites de classes de tailles (classes irrégulières).}\label{fig:unnamed-chunk-49}
\end{figure}
...
\caption{Distribution des températures avec visualisation des données mensuelles.}\label{fig:unnamed-chunk-51}
\end{figure}
...
\caption{Un boxplot for peu utile...}\label{fig:unnamed-chunk-52}
\end{figure}
...
\caption{Boxplot des températures mensuelles.}\label{fig:unnamed-chunk-53}
\end{figure}
...
{\centering \includegraphics[width=0.9\linewidth]{figure/unnamed-chunk-91-1} 

}

\caption{Notre premier graphique, produit grâce au pipe}\label{fig:unnamed-chunk-91}
\end{figure}
...
{\centering \includegraphics[width=0.5\linewidth]{figure/unnamed-chunk-134-1} 

}

\caption{Indice Gonado Somatique  selon le sexe.}\label{fig:unnamed-chunk-134}
\end{figure}
